...
public class KeywordActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    ArrayList<String> your_array_list = new ArrayList<String>();
         ...
         new ArrayAdapter<String>(KeywordActivity.this,android.R.layout.simple_list_item_1, your_array_list);
         ...
         keywords.setOnItemClickListener(new OnItemClickListener() {
             ...
             public void onItemClick(AdapterView<?> parent, View view,
            	...
            	//---------- want to pass the value of the list item to the textview on the main screen -------------
