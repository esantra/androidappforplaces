...
//code taken from: http://wptrafficanalyzer.in/blog/showing-nearby-places-with-photos-at-any-location-in-google-maps-android-api-v2/
...
public class PlaceJSONParser {
    ...
    public PlaceParcel[] parse(JSONObject jObject){
    ...
    private PlaceParcel[] getPlaces(JSONArray jPlaces){
        int placesCount = jPlaces.length();
        PlaceParcel[] places = new PlaceParcel[placesCount];
    ...
    private PlaceParcel getPlace(JSONObject jPlace){
 
        PlaceParcel place = new PlaceParcel();
        ...
        try {
            ...
            if(!jPlace.isNull("photos")){
                ...
                place.mPhotos = new PlacePhoto[photos.length()];
                for(int i=0;i<photos.length();i++){
                    place.mPhotos[i] = new PlacePhoto();
